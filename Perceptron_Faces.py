...
def read_faces(sample_file, sample_num, pool):
    f = open(sample_file)
    line = f.readlines()
...
def process_data(data_file, label_file, pool):
    label, sample_num = read_labels(label_file)
    data = read_faces(data_file, sample_num, pool)
    new_data=[]
...
def main():
    pool = 2
    train = "C:/Users/Abdul Rehman/Downloads/Project Perfect/Classifiers/code/facedata/facedatatrain"
    train_label = "C:/Users/Abdul Rehman/Downloads/Project Perfect/Classifiers/code/facedata/facedatatrainlabels"
    test = "C:/Users/Abdul Rehman/Downloads/Project Perfect/Classifiers/code/facedata/facedatatest"
    test_label = "C:/Users/Abdul Rehman/Downloads/Project Perfect/Classifiers/code/facedata/facedatatestlabels"
